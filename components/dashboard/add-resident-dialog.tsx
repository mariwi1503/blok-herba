...
export function AddResidentDialog({ open, onOpenChange }: AddResidentDialogProps) {
  ...
  const roles = ["Warga", "Ketua RT", "Sekretaris RT", "Bendahara RT", "Koordinator Keamanan"]
  const religions = ["Islam", "Kristen", "Katolik", "Hindu", "Buddha", "Konghucu", "Lainnya"]

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Handle resident creation here
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-heading text-xl">Tambah Warga Baru</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup defaultValue="belum-menikah" className="flex space-x-6">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup defaultValue="ktp-batam" className="flex space-x-6">
                <div className="flex items-center space-x-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup defaultValue="rumah" className="flex space-x-6">
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup defaultValue="milik-sendiri" className="flex space-x-6">
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="role" className="font-body font-medium">
                Jabatan di RT
              </Label>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="notes" placeholder="Catatan tambahan tentang warga" />
            </div>
          </div>
